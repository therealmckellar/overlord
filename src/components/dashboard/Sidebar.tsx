...
const navGroups = [
  {
    ...
    items: [
      ...
      { id: 'tokens',     label: 'Token Costs',  icon: '💰', panel: 'tokens' },
    ],
  },
  {
    id: 'agents',
    label: '🤖 AGENTS & MODELS',
    items: [
      { id: 'agent',      label: 'Agent Roster',   icon: '🤖', panel: 'agent' },
      { id: 'designer',   label: 'Agent Designer', icon: '🧬', panel: 'designer' },
      { id: 'deploy',     label: 'Deployments',    icon: '🚀', panel: 'deploy' },
      { id: 'mission',    label: 'Mission Control', icon: '🛸', panel: 'mission' },
      { id: 'loop',       label: 'Loop Engine',    icon: '🔁', panel: 'loop' },
    ],
  },
  {
    id: 'chat',
    ...
    items: [
      ...
      { id: 'session',    label: 'Sessions',       icon: '🗂️', panel: 'session' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'agentOffice', label: 'Agent Office',  icon: '🏢', panel: 'agentOffice' },
    ],
  },
  {
    id: 'knowledge',
    label: '🧠 KNOWLEDGE',
    items: [
      { id: 'memory',      label: 'Memory Galaxy',  icon: '🧠', panel: 'memory' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'substack',       label: 'Content Studio', icon: '✍️', panel: 'substack' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'mcp',       label: 'MCP Servers',  icon: '🔌', panel: 'mcp' },
    ],
  },
  {
    id: 'system',
